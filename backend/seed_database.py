...
async def seed_database():
    ...
    # Store as string for consistency with backend queries
    ...
    print(f"Category IDs: {list(category_ids.values())[:3]}...")  # Debug: show first 3 IDs
    ...
    products = [
        ...
        },
        {
            ...
            "description": "Consolă Nintendo Switch OLED cu ecran OLED de 7 inch și dock îmbunătățit.",
            "category": "console-gaming",
            "brand": "Nintendo",
            "price": 1599,
            "oldPrice": 1799,
            ...
            "images": ["https://images.unsplash.com/photo-1578303512597-81e6cc155b3e?w=500&q=80"],
            "inStock": True,
            "stock": 25,
            "isNew": False,
            "discount": 11,
        ...
        # Accesorii Gaming
        {
            ...
            "description": "Mouse gaming wireless Razer DeathAdder V3 Pro cu senzor Focus Pro 30K și autonomie 90 ore.",
            "category": "accesorii-gaming",
            "brand": "Razer",
            "price": 699,
            "oldPrice": 849,
            "rating": 4.8,
        ...
        },
        {
            ...
            "description": "Mouse gaming ultraușor Logitech G Pro X Superlight 2 cu senzor HERO 2 și greutate sub 60g.",
            "category": "accesorii-gaming",
            "brand": "Logitech",
            "price": 799,
            "oldPrice": None,
            ...
            "images": ["https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=500&q=80"],
            "inStock": True,
            "stock": 35,
            "isNew": True,
            "discount": 0,
